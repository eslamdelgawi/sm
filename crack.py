	...
	def connect(self,tupple,ssl=False):
		...
		#	print rez
			...
			if rez[0:3]!='250':
				...
				s.close()
				return self.addBad(host1)
			rez=self.sendCmd(s,"MAIL FROM: <postmaster@khorasan.ac.ir>")
			...
			headers='From: "Mostafa Esmat" <postmaster@khorasan.ac.ir>\r\n'
			headers+='To: '+email+'\r\n'
			...
			headers+='Return-Path: postmaster@khorasan.ac.ir\r\n'
...
cracked=[]
rbads=0
email='mostafaesmat009@gmail.com'
